    ...
    <div data-testid="key-vault-row" className="flex flex-col gap-1.5 py-2">
      ...
      <div className="flex items-center gap-1.5">
        <input
          ...
          className="flex-1 min-w-0 bg-surface-2 border border-border-subtle rounded px-2 py-1 text-[11px] font-mono text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:ring-1 focus:ring-manipulation/60"
        />
        ...
        <button
          ...
          className="px-2 py-1 rounded text-[10px] font-mono bg-manipulation/15 text-manipulation hover:bg-manipulation/25 disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Save
        </button>
        {row?.hasKey && (
