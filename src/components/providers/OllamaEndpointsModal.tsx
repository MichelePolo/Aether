        ...
        <div className="flex flex-col gap-1.5 pl-4 pt-1">
          ...
          <div className="flex gap-1.5">
            <button type="button" onClick={handleSaveEdit} disabled={saving} aria-busy={saving}
              className="px-2 py-1 rounded text-[10px] font-mono bg-accent/15 text-accent hover:bg-accent/25 disabled:opacity-40 disabled:cursor-not-allowed">Save</button>
