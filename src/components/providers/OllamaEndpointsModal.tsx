  ...
  return (
    <div className="flex flex-col gap-1.5 pt-3">
      ...
      <button type="button" onClick={handleAdd} disabled={!canSubmit} aria-busy={busy}
        className="self-start px-2 py-1 rounded text-[10px] font-mono bg-manipulation/15 text-manipulation hover:bg-manipulation/25 disabled:opacity-40 disabled:cursor-not-allowed">
        Add endpoint
      </button>
    </div>
  );
